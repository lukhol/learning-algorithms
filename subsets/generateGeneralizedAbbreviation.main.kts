...
fun main() {
     ...
     */
    fun generateGeneralizedAbbreviation_wrong(word: String): List<String> {
        ...
        fun dfs(startIdx: Int, curr: StringBuilder) {
            ...
            for (i in startIdx..curr.lastIndex) {
                ...
                val nextIdx = if (collapseNumbersIdx == i - 1) i + 1 else i
    ...
    println(generateGeneralizedAbbreviation("BAT") == listOf("BAT", "1AT", "2T", "3", "1A1", "B1T", "B2", "BA1"))
    println(
        generateGeneralizedAbbreviation("code").containsAll(
            listOf(
                "code",
                "cod1",
                "co1e",
